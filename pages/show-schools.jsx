  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4 sm:p-6 md:p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-center text-gray-900 mb-8">All Schools</h1>
        {schools.length === 0 ? (
            ...
            {schools.map((school) => (
              <div key={school.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="w-full h-48 bg-gray-200">
                  {/* Displays the school's name, address, city, and image  */}
                  <img
                ...
                <div className="p-4">
                  <h2 className="text-lg font-semibold text-gray-900 truncate">{school.name}</h2>
